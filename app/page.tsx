  ...
  return (
    <main className="flex min-h-screen flex-col items-center">
      ...
      <section className="relative w-full h-screen flex items-center justify-center overflow-hidden bg-black text-white">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto flex flex-col md:flex-row-reverse items-center justify-center gap-8">
          ...
          <div className="text-center md:text-left">
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6">
              Hello, I'm <span className="text-gray-300">Alex</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4 justify-center md:justify-start">
              <Link
                href="#projects"
                className="inline-flex items-center justify-center rounded-full bg-white text-black px-8 py-3 text-base font-medium hover:bg-gray-200 transition-colors duration-300"
              >
                View My Work
              </Link>
              <Link
